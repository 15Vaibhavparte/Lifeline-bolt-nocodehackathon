...
DROP VIEW IF EXISTS blood_type_statistics;
DROP VIEW IF EXISTS recipient_compatibility;
DROP VIEW IF EXISTS blood_type_compatibility;
DROP VIEW IF EXISTS mock_donors;
DROP FUNCTION IF EXISTS search_mock_donors;
DROP FUNCTION IF EXISTS get_mock_blood_drives;
